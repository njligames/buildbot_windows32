...
set_target_properties(NJLIC::NJLIC-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC-static.lib"
  )
...
set_target_properties(NJLIC::NJLIC PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC.lib"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/NJLIC.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-bullet3-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-bullet3-static.lib"
  )
...
# Import target "NJLIC::NJLIC-lua-swig-njlic-module" for configuration "RelWithDebInfo"
set_property(TARGET NJLIC::NJLIC-lua-swig-njlic-module APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(NJLIC::NJLIC-lua-swig-njlic-module PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic-module.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-njlic PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic.lib"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/NJLIC-lua-swig-njlic.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-njlic-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic-static.lib"
  )
