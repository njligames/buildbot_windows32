...
set_target_properties(NJLIC::NJLIC-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC-static.lib"
  )
...
set_target_properties(NJLIC::NJLIC PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/NJLIC.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-bullet3-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-bullet3-static.lib"
  )
...
# Import target "NJLIC::NJLIC-lua-swig-njlic-module" for configuration "Release"
set_property(TARGET NJLIC::NJLIC-lua-swig-njlic-module APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(NJLIC::NJLIC-lua-swig-njlic-module PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic-module.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-njlic PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/NJLIC-lua-swig-njlic.dll"
  )
...
set_target_properties(NJLIC::NJLIC-lua-swig-njlic-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/NJLIC-lua-swig-njlic-static.lib"
  )
